MODULE STOKESTRN_FC_MOD
  ...
  & CIMSSTRN_XKI, CIMSSTRN_E, CIMSSTRN_SUME, STOKESDRIFT_STFAC)
    ...
    INTERFACE
      ...
      & LWCOU, LWNEMOCOU, LWNEMOCOUSEND, LWNEMOCOUSTK, LWNEMOCOUSTRN, NANG, NFRE, NFRE_ODD, ROWATER, SINTH, ZPI, ICHNK, NCHNK,  &
      & IJ, CIMSSTRN_XKI, CIMSSTRN_E, CIMSSTRN_SUME, STOKESDRIFT_STFAC) BIND(c, name="stokestrn_c_launch")
...
!$acc & NEMOUSTOKES, NEMOVSTOKES, NEMOSTRN, COSTH, DFIM, DFIM_SIM, FR, SINTH, CIMSSTRN_XKI, CIMSSTRN_E, CIMSSTRN_SUME,  &
!$acc & STOKESDRIFT_STFAC )
    ...
    & NCHNK, IJ, c_loc(CIMSSTRN_XKI), c_loc(CIMSSTRN_E), c_loc(CIMSSTRN_SUME), c_loc(STOKESDRIFT_STFAC))
!$acc end host_data
