MODULE IMPHFTAIL_FC_MOD
  USE iso_c_binding
  CONTAINS
  SUBROUTINE IMPHFTAIL_fc (KIJS, KIJL, MIJ, FLM, WAVNUM, XK2CG, FL1, NANG, NFRE, ICHNK, NCHNK, IJ, TEMP1, TEMP2)
    ...
    INTERFACE
      SUBROUTINE IMPHFTAIL_iso_c (KIJS, KIJL, MIJ, FLM, WAVNUM, XK2CG, FL1, NANG, NFRE, ICHNK, NCHNK, IJ, TEMP1, TEMP2) &
