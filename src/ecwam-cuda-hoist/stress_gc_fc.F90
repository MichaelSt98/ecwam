MODULE STRESS_GC_FC_MOD
  ...
  & XK_GC, XLOGKRATIOM1_GC, ZALP, GAM_W)
...
!$acc routine seq
    INTERFACE
      ...
      & XKMSQRTVGOC2_GC, XKM_GC, XK_GC, XLOGKRATIOM1_GC, ZALP, GAM_W) BIND(c, name="stress_gc_c_launch")
...
!$acc & XK_GC, GAM_W )
    ...
    & SQRTGOSURFT, XKAPPA, c_loc(XKMSQRTVGOC2_GC), c_loc(XKM_GC), c_loc(XK_GC), XLOGKRATIOM1_GC, ZALP, c_loc(GAM_W))
!$acc end host_data
