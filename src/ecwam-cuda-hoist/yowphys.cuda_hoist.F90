...
!$loki dimension( NANG,NSDSNTH*2+1 )
  ...
  ! ----------------------------------------------------------------------
!$acc declare create(  &
!$acc & CHNKMIN_U,DTHRN_A,BMAXOKAP,TAILFACTOR,CDISVIS,ANG_GC_B,TAUWSHELTER,SWELLF7M1,ZALP,DELTA_SDIS,Z0RAT,DTHRN_U,ANG_GC_C,RN1_RN,Z0TUBMAX,TAILFACTOR_PM,SWELLF7,CDIS,GAMNCONST,INDICESSAT,ALPHAPMAX,SSDSC5,RNUM,SATWEIGHTS,ANG_GC_A,SWELLF4,ALPHAMIN,RNU,BETAMAXOXKAPPA2,ALPHA,NSDSNTH &
!$acc &  )
END MODULE YOWPHYS
