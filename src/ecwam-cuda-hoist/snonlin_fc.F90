MODULE SNONLIN_FC_MOD
  ...
  & NCHNK, IJ, ENH, XNU, SIG_TH, FTEMP, AD, DELAD, DELAP, DELAM, ENHFR, PEAK_ANG_MMAX, PEAK_ANG_SUM0, PEAK_ANG_SUM1,  &
  & PEAK_ANG_SUM2, PEAK_ANG_XMAX, PEAK_ANG_TEMP, PEAK_ANG_THMEAN, PEAK_ANG_SUM_S, PEAK_ANG_SUM_C)
    ...
    INTERFACE
      ...
      &  BIND(c, name="snonlin_c_launch")
        ...
        TYPE(c_ptr), VALUE :: FTEMP
        TYPE(c_ptr), VALUE :: AD
        TYPE(c_ptr), VALUE :: DELAD
        TYPE(c_ptr), VALUE :: DELAP
        TYPE(c_ptr), VALUE :: DELAM
        TYPE(c_ptr), VALUE :: ENHFR
    ...
    REAL(KIND=JWRB), TARGET, INTENT(INOUT) :: FTEMP(:, :)
    REAL(KIND=JWRB), TARGET, INTENT(INOUT) :: AD(:, :)
    REAL(KIND=JWRB), TARGET, INTENT(INOUT) :: DELAD(:, :)
    REAL(KIND=JWRB), TARGET, INTENT(INOUT) :: DELAP(:, :)
    REAL(KIND=JWRB), TARGET, INTENT(INOUT) :: DELAM(:, :)
    REAL(KIND=JWRB), TARGET, INTENT(INOUT) :: ENHFR(:, :)
...
!$acc & FKLAP1, FR, IKM, IKM1, IKP, IKP1, INLCOEF, K11W, K1W, K21W, K2W, RNLCOEF, SINTH, TH, ZPIFR, ENH, XNU, SIG_TH, FTEMP, AD,  &
!$acc & DELAD, DELAP, DELAM, ENHFR, PEAK_ANG_MMAX, PEAK_ANG_SUM0, PEAK_ANG_SUM1, PEAK_ANG_SUM2, PEAK_ANG_XMAX, PEAK_ANG_TEMP,  &
!$acc & PEAK_ANG_THMEAN, PEAK_ANG_SUM_S, PEAK_ANG_SUM_C )
    ...
    & c_loc(SIG_TH), c_loc(FTEMP), c_loc(AD), c_loc(DELAD), c_loc(DELAP), c_loc(DELAM), c_loc(ENHFR), c_loc(PEAK_ANG_MMAX),  &
    & c_loc(PEAK_ANG_SUM0), c_loc(PEAK_ANG_SUM1), c_loc(PEAK_ANG_SUM2), c_loc(PEAK_ANG_XMAX), c_loc(PEAK_ANG_TEMP),  &
    & c_loc(PEAK_ANG_THMEAN), c_loc(PEAK_ANG_SUM_S), c_loc(PEAK_ANG_SUM_C))
!$acc end host_data
