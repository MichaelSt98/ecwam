...
!$loki dimension( MFRSTLW:1 )
  REAL(KIND=JWRB), ALLOCATABLE :: FTRF(:)
!$loki dimension( NRNL,1:MLSTHG )
  ...
  ! ----------------------------------------------------------------------
!$acc declare create(  &
!$acc & INLCOEF,KFRH,K1W,IKM1,IKM,K11W,FKLAP1,K21W,RNLCOEF,AF11,FKLAM,IKP1,MFRSTLW,FKLAP,IKP,K2W,DAL1,MLSTHG,DAL2,FKLAM1 )
END MODULE YOWINDN
