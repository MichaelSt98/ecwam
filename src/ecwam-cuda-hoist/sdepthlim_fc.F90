MODULE SDEPTHLIM_FC_MOD
  USE iso_c_binding
  CONTAINS
  SUBROUTINE SDEPTHLIM_fc (KIJS, KIJL, EMAXDPT, FL1, DELTH, DFIM, EPSMIN, FR, NANG, NFRE, WETAIL, ICHNK, NCHNK, IJ, EM,  &
  & SEMEAN_TEMP)
    ...
    INTERFACE
      SUBROUTINE SEMEAN (FL1, KIJS, KIJL, EM, LLEPSMIN)
        ...
        REAL(KIND=JWRB), INTENT(OUT), DIMENSION(KIJL) :: EM
    ...
    INTERFACE
      SUBROUTINE SDEPTHLIM_iso_c (KIJS, KIJL, EMAXDPT, FL1, DELTH, DFIM, EPSMIN, FR, NANG, NFRE, WETAIL, ICHNK, NCHNK, IJ, EM,  &
      & SEMEAN_TEMP) BIND(c, name="sdepthlim_c_launch")
