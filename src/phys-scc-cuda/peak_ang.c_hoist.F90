...
!
ATTRIBUTES(DEVICE) SUBROUTINE PEAK_ANG_FC (KIJS, KIJL, FL1, XNU, SIG_TH, COSTH, DELTH, DFIM, DFIMFR, DFIMFR2, FR, FRATIO, NANG,  &
& NFRE, SINTH, TH, WETAIL, WP1TAIL, WP2TAIL, ICHNK, NCHNK, IJ)
