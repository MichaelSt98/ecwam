...
!
ATTRIBUTES(DEVICE) SUBROUTINE FRCUTINDEX_FC (KIJS, KIJL, FM, FMWS, UFRIC, CICOVER, MIJ, RHOWGDFTH, CITHRSH_TAIL, EPSMIN,  &
& FLOGSPRDM1, FR, FRIC, G, NFRE, RHOWG_DFIM, TAILFACTOR, TAILFACTOR_PM, ZPIFR, ICHNK, NCHNK, IJ)
