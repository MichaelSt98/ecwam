...
!
ATTRIBUTES(DEVICE) SUBROUTINE SINPUT_FC (NGST, LLSNEG, KIJS, KIJL, FL1, WAVNUM, CINV, XK2CG, WDWAVE, WSWAVE, UFRIC, Z0M,  &
...
& Z0RAT, Z0TUBMAX, ZALP, ZPI, ZPIFR, ICHNK, NCHNK, IJ)
  ...
  SELECT CASE (IPHYS)
  CASE (0)
    CALL SINPUT_JAN_FC(NGST, LLSNEG, KIJS, KIJL, FL1(:, :, :, :), WAVNUM(:, :, :), CINV(:, :, :), XK2CG(:, :, :), WSWAVE(:, :),  &
    & UFRIC(:, :), Z0M(:, :), COSWDIF(:, :), SINWDIF2(:, :), RAORW(:), WSTAR(:, :), RNFAC(:), FLD(:, :, :), SL(:, :, :),  &
    & SPOS(:, :, :), XLLWS(:, :, :, :), ACDLIN, ALPHAMAX, ALPHAMIN, BCDLIN, BETAMAXOXKAPPA2, DELTH, EPSUS, G, IDAMPING, LLGCBZ0,  &
    & LLNORMAGAM, NANG, NFRE, RNUM, WSPMIN, XKAPPA, ZALP, ZPI, ZPIFR(:), ICHNK, NCHNK, IJ)
  CASE (1)
    CALL SINPUT_ARD_FC(NGST, LLSNEG, KIJS, KIJL, FL1(:, :, :, :), WAVNUM(:, :, :), CINV(:, :, :), XK2CG(:, :, :), WDWAVE(:, :),  &
    & WSWAVE(:, :), UFRIC(:, :), Z0M(:, :), COSWDIF(:, :), SINWDIF2(:, :), RAORW(:), WSTAR(:, :), RNFAC(:), FLD(:, :, :),  &
    & SL(:, :, :), SPOS(:, :, :), XLLWS(:, :, :, :), ABMAX, ABMIN, ACDLIN, ALPHAMAX, ALPHAMIN, BCDLIN, BETAMAXOXKAPPA2,  &
    & COSTH(:), DELTH, DFIM(:), EPSMIN, EPSUS, G, IAB, LLGCBZ0, LLNORMAGAM, NANG, NFRE, RNU, RNUM, SINTH(:), SWELLF, SWELLF2,  &
    & SWELLF3, SWELLF4, SWELLF5, SWELLF6, SWELLF7, SWELLF7M1, SWELLFT(:), TAUWSHELTER, TH(:), WSPMIN, XKAPPA, Z0RAT, Z0TUBMAX,  &
