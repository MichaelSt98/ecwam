...
MODULE SINPUT_ARD_FC_MOD
  ...
  ! - SINPUT_JAN
  CONTAINS
  ATTRIBUTES(DEVICE) SUBROUTINE WSIGSTAR_FC (WSWAVE, UFRIC, Z0M, WSTAR, SIG_N, ACDLIN, ALPHAMAX, ALPHAMIN, BCDLIN, EPSUS, G,  &
  & LLGCBZ0, RNUM, WSPMIN, XKAPPA)
    ! ----------------------------------------------------------------------
...
!$acc routine seq
  ...
  ATTRIBUTES(DEVICE) SUBROUTINE SINPUT_ARD_FC (NGST, LLSNEG, KIJS, KIJL, FL1, WAVNUM, CINV, XK2CG, WDWAVE, WSWAVE, UFRIC, Z0M,  &
  & COSWDIF, SINWDIF2, RAORW, WSTAR, RNFAC, FLD, SL, SPOS, XLLWS, ABMAX, ABMIN, ACDLIN, ALPHAMAX, ALPHAMIN, BCDLIN,  &
  ...
  & ZALP, ZPI, ZPIFR, ICHNK, NCHNK, IJ)
    ...
    IF (NGST > 1) THEN
      CALL WSIGSTAR_FC(WSWAVE(IJ, ICHNK), UFRIC(IJ, ICHNK), Z0M(IJ, ICHNK), WSTAR(IJ, ICHNK), SIG_N, ACDLIN, ALPHAMAX, ALPHAMIN,  &
      & BCDLIN, EPSUS, G, LLGCBZ0, RNUM, WSPMIN, XKAPPA)
    END IF
  ...
  ATTRIBUTES(DEVICE) SUBROUTINE SINPUT_JAN_FC (NGST, LLSNEG, KIJS, KIJL, FL1, WAVNUM, CINV, XK2CG, WSWAVE, UFRIC, Z0M, COSWDIF,  &
  & SINWDIF2, RAORW, WSTAR, RNFAC, FLD, SL, SPOS, XLLWS, ACDLIN, ALPHAMAX, ALPHAMIN, BCDLIN, BETAMAXOXKAPPA2, DELTH, EPSUS, G,  &
