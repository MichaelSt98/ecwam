MODULE SDISSIP_JAN_FC_MOD
  ...
  & RNU, ZPI, ICHNK, NCHNK, IJ)
    ...
    INTERFACE
      ...
      & NFRE, RNU, ZPI, ICHNK, NCHNK, IJ) BIND(c, name="sdissip_jan_c_launch")
...
!$acc host_data use_device( FL1, FLD, SL, WAVNUM, EMEAN, F1MEAN, XKMEAN )
    CALL SDISSIP_JAN_iso_c(KIJS, KIJL, c_loc(FL1), c_loc(FLD), c_loc(SL), c_loc(WAVNUM), c_loc(EMEAN), c_loc(F1MEAN),  &
    & c_loc(XKMEAN), CDIS, CDISVIS, DELTA_SDIS, NANG, NFRE, RNU, ZPI, ICHNK, NCHNK, IJ)
!$acc end host_data
