...
!
ATTRIBUTES(DEVICE) SUBROUTINE TAUT_Z0_FC (KIJS, KIJL, IUSFG, HALP, UTOP, UDIR, TAUW, TAUWDIR, RNFAC, USTAR, Z0, Z0B, CHRNCK,  &
& ACD, ALPHA, ALPHAMAX, ALPHAMIN, ANG_GC_A, ANG_GC_B, ANG_GC_C, BCD, BETAMAXOXKAPPA2, BMAXOKAP, C2OSQRTVG_GC, CDMAX, CHNKMIN_U,  &
& CM_GC, DELKCC_GC_NS, DELKCC_OMXKM3_GC, EPS1, EPSMIN, EPSUS, G, GM1, LLCAPCHNK, LLGCBZ0, LLNORMAGAM, NWAV_GC, OM3GMKM_GC,  &
& OMXKM3_GC, RN1_RN, RNU, RNUM, SQRTGOSURFT, XKAPPA, XKMSQRTVGOC2_GC, XKM_GC, XK_GC, XLOGKRATIOM1_GC, XNLEV, ZALP, ICHNK, NCHNK,  &
& IJ)
  ...
  IF (LLGCBZ0) THEN
    ...
    IF (LLCAPCHNK) THEN
      CHARNOCK_MIN = CHNKMIN_FC(UTOP(IJ, ICHNK), ALPHA, ALPHAMIN, CHNKMIN_U)
      ALPHAOG = CHARNOCK_MIN*GM1
    ELSE
      ALPHAOG = 0.0_JWRB
    END IF
    
    USMAX = MAX(-0.21339_JWRB + 0.093698_JWRB*UTOP(IJ, ICHNK) - 0.0020944_JWRB*UTOP(IJ, ICHNK)**2 + 5.5091E-5_JWRB*UTOP(IJ, ICHNK &
    & )**3, 0.03_JWRB)
    ...
    DO ITER=1,NITER
      ...
      TAUUNR = STRESS_GC_FC(ANG_GC, USTAR(IJ, ICHNK), Z0(IJ, ICHNK), Z0MIN, HALP(IJ), RNFAC(IJ), BETAMAXOXKAPPA2, BMAXOKAP,  &
    ...
    IF (X < 0.99_JWRB) THEN
      ...
      DO ITER=1,NITER
        ...
        TAUUNR = STRESS_GC_FC(ANG_GC, USTOLD, Z0(IJ, ICHNK), Z0MIN, HALP(IJ), RNFAC(IJ), BETAMAXOXKAPPA2, BMAXOKAP, C2OSQRTVG_GC, &
        &  CM_GC, DELKCC_GC_NS, DELKCC_OMXKM3_GC, EPSUS, LLNORMAGAM, NWAV_GC, OM3GMKM_GC, OMXKM3_GC, RN1_RN, SQRTGOSURFT, XKAPPA, &
