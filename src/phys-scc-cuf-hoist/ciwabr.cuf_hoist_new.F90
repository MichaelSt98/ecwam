...
!
MODULE CIWABR_CUF_HOIST_NEW_MOD
  CONTAINS
  ATTRIBUTES(DEVICE) SUBROUTINE CIWABR_CUF_HOIST_NEW (KIJS, KIJL, CICOVER, FL1, WAVNUM, CGROUP, CIWAB, CDICWA, DFIM, EPSMIN,  &
  & IDELT, LICERUN, LMASKICE, NANG, NFRE, ICHNK, NCHNK, IJ)
    ...
    USE YOWPCONS, ONLY: ZPI4GM2, ZPI, G
    ...
    REAL(KIND=JWRB), INTENT(OUT) :: CIWAB(KIJL, NANG_loki_param, NFRE_loki_param)
  ...
  END SUBROUTINE CIWABR_CUF_HOIST_NEW
END MODULE CIWABR_CUF_HOIST_NEW_MOD
