...
!
MODULE HALPHAP_CUF_HOIST_NEW_MOD
  CONTAINS
  ATTRIBUTES(DEVICE) SUBROUTINE HALPHAP_CUF_HOIST_NEW (KIJS, KIJL, WAVNUM, COSWDIF, FL1, HALP, ALPHAPMAX, DELTH, DFIM, DFIMOFR,  &
  & EPSMIN, FR, FR5, FRTAIL, NANG, NFRE, WETAIL, ZPI4GM2, ICHNK, NCHNK, IJ)
    ...
    REAL(KIND=JWRB), INTENT(OUT) :: HALP(KIJL)
  ...
  END SUBROUTINE HALPHAP_CUF_HOIST_NEW
END MODULE HALPHAP_CUF_HOIST_NEW_MOD
