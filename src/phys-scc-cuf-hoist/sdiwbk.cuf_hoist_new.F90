...
!
MODULE SDIWBK_CUF_HOIST_NEW_MOD
  CONTAINS
  ATTRIBUTES(DEVICE) SUBROUTINE SDIWBK_CUF_HOIST_NEW (KIJS, KIJL, FL1, FLD, SL, DEPTH, EMAXDPT, EMEAN, F1MEAN, LBIWBK, NANG,  &
  ...
  END SUBROUTINE SDIWBK_CUF_HOIST_NEW
END MODULE SDIWBK_CUF_HOIST_NEW_MOD
