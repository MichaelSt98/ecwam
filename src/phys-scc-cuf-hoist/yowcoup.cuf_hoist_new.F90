...
MODULE YOWCOUP
  ...
  INTEGER(KIND=JWIM), PARAMETER :: JTOT_TAUHF = 19
  ! must be odd !!!
  ...
  CHARACTER(LEN=32) :: IFSCONTEXT
  ! Corresponds to ALGORITHM_STATE_MOD%GET_ALGOR_TYPE()
  INTEGER(KIND=JWIM) :: IFSNUPTRA
  ! Corresponds to ALGORITHM_STATE_MOD%GET_NUPTRA()
  INTEGER(KIND=JWIM) :: IFSMUPTRA
  ! Corresponds to ALGORITHM_STATE_MOD%GET_MUPTRA()
