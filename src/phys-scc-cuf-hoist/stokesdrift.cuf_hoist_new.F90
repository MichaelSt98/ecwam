...
!
MODULE STOKESDRIFT_CUF_HOIST_NEW_MOD
  CONTAINS
  ATTRIBUTES(DEVICE) SUBROUTINE STOKESDRIFT_CUF_HOIST_NEW (KIJS, KIJL, FL1, STOKFAC, WSWAVE, WDWAVE, CICOVER, USTOKES, VSTOKES,  &
  & CITHRSH, COSTH, DELTH, DFIM_SIM, FR, G, LICERUN, LWAMRSETCI, NANG, NFRE_ODD, SINTH, ZPI, ICHNK, NCHNK, IJ)
    ...
    REAL(KIND=JWRB), INTENT(OUT) :: USTOKES(KIJL, NCHNK)
    REAL(KIND=JWRB), INTENT(OUT) :: VSTOKES(KIJL, NCHNK)
  ...
  END SUBROUTINE STOKESDRIFT_CUF_HOIST_NEW
END MODULE STOKESDRIFT_CUF_HOIST_NEW_MOD
