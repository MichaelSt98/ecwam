...
# /users/staneker/rocm-afar-7450-drop-6.0.0
LD_LIBRARY_PATH=/users/staneker/rocm-afar-7450-drop-6.0.0/lib:$LD_LIBRARY_PATH
LD_LIBRARY_PATH=/users/staneker/rocm-afar-7450-drop-6.0.0/lib/llvm/lib:$LD_LIBRARY_PATH
export LD_LIBRARY_PATH=$LD_LIBRARY_PATH
PATH=/users/staneker/rocm-afar-7450-drop-6.0.0/lib/llvm/bin:$PATH
PATH=/users/staneker/rocm-afar-7450-drop-6.0.0/bin:$PATH
export PATH=$PATH
#export hipfort_ROOT=/users/nawabahm/hipfort/install
